...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Vincent Masse</title>
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
  </head>
  <body>
    <div class="container-fluid background-image">
      <img class="img-fluid" src="IMG_20201024_090805.png" alt="Avatar">
      ...
      <div class="titles text-center">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenu">
            ...
            <p class="dropdown-item">102, rue du Gras Boeuf</p>
            <p class="dropdown-item">n°81, résidence les 5 pommes</p>
            <p class="dropdown-item">59163 Condé sur l'Escaut</p>
            <p class="dropdown-item">+33 6 28 53 65 98</p>
            <p class="dropdown-item">vincentmasse@protonmail.com</p>
          </div>
        </div>
      </div>
      <!--
      <div class="d-flex text-center cv-header">
        <div class="col-4">
          <button type="button" class="btn btn-primary  mr-5" href="#">Liens</button>
        </div>
        ...
        <div class="col-4">
          <button type="button" class="btn btn-primary ml-5" href="#">Contact</button>
        </div>
      </div>
-->
      <div class="cv-body">
        <nav class="mb-3 mt-5 navbar">
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            onclick="manageNavbarContent('nav-trainings')">Formations</a>
            <a class="nav-item nav-link" id="nav-xp-tab" data-toggle="tab" href="#nav-xp" role="tab" aria-controls="nav-xp" aria-selected="false" onclick="manageNavbarContent('nav-xp')">Expériences</a>
            <a class="nav-item nav-link" id="nav-languages-tab" data-toggle="tab" href="#nav-languages" role="tab" aria-controls="nav-languages" aria-selected="false" onclick="manageNavbarContent('nav-languages')">Langues</a>
            <a class="nav-item nav-link" id="nav-passions-tab" data-toggle="tab" href="#nav-passions" role="tab" aria-controls="nav-passions" aria-selected="false" onclick="manageNavbarContent('nav-passions')">Passions</a>
          </div>
        </nav>
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade active show" id="nav-trainings" role="tabpanel" aria-labelledby="nav-trainings-tab" style="display:none">
            <p><span class="underline">nov 2020 - :</span>    19network42 coding school, Bruxelles</p>
            <p><span class="underline">oct 2020 - aout 2021:</span> Formation full-stack Valarep, Valenciennes</p>
            <p><span class="underline">avril - juin 2020 :</span> Formation découverte web dev, The Hacking Project</p>
            <p><span class="underline">2017 - 2019 :</span> Etude autodidacte programmation informatique</p>
            <p><span class="underline">2014 - 2016 :</span> Arts Graphiques, St Luc Tournai</p>
            <p><span class="underline">2013 :</span> Baccalauréat STD2A (Arts Appliqués), Louvroil</p>
            <hr class="mt-5">
          </div>
          ...
          <div class="tab-pane fade active show" id="nav-xp" role="tabpanel" aria-labelledby="nav-xp-tab" style="display:none">
            ...
            <p><span class="underline">août 2016 :</span> Chantier participatif d'archéologie et de restauration de bâtiments anciens, Siedlecin, Pologne</p>
            <hr class="mt-5">
          </div>

          <div class="tab-pane fade active show" id="nav-languages" role="tabpanel" aria-labelledby="nav-languages-tab" style="display:none">
            <p><span class="underline">Français</span> :
            ...
            <p><span class="underline">Anglais</span> :
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
            ...
            <p><span class="underline">Allemand</span> :
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="far fa-star"></i>
            ...
            <p><span class="underline">Espagnol</span> :
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
            ...
            <p><span class="underline">Italien</span> :
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
            ...
            <p><span class="underline">Hindi</span> :
              <i class="fas fa-star"></i>
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
          ...
          <div class="tab-pane fade active show" id="nav-passions" role="tabpanel" aria-labelledby="nav-passions-tab" style="display:none">
            <p>
  ...
  <!-- NAVBAR -->
  <script>
  function manageNavbarContent(id) {
